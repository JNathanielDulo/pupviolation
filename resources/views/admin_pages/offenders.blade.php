                ...
                <div class="modal-body">
                    <form>
                        ...
                        <div class="mb-3">
                          ...
                          <div class="mb-3">
                            <label for="exampleInputper_classifications" class="form-label">Number of Offenses (Per Classifications)</label>
                          ...
                          <div class="mb-3">
                            <label for="exampleInputsanction" class="form-label">Sanctions</label>
                            <input type="sanction" class="form-control" id="exampleInputsanction">
                          </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                          <div class="card-header">
                            <h3 class="card-title">Lists of Offenders</h3>
