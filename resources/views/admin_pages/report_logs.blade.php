                                  ...
                                  <div class="modal-body">
                                      <form>
                                         ...
                                         <select name="monthID" class="form-control">
                                            ...
                                            <div class="mb-3">
                                              <label for="exampleInput" class="form-label">Select Year</label>
                                              <input type="year" class="form-control" id="exampleInputyear">
                                            </div>
                            ...
                            <table class="table table-hover text-nowrap">
                              ...
                              <tbody>
                                <tr>
                                    ...
                                    <td>1st</td>
                                    <th><button type="button" class="btn btn-success">Download</button>
                                ...
                                <tr>
                                    ...
                                    <td>2nd</td>
                                    <th><button type="button" class="btn btn-success">Download</button>
                                        <button type="button" class="btn btn-info">Print</button></th>
                                </tr>
                                <tr>
